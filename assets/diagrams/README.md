...
`performance.mmd` (the speed chart) is generated from the benchmark results by the capture work, not typed by
hand; the render script picks up every `.mmd` in this directory.
