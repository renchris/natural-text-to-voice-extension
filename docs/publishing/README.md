...
How version 1.5.1 goes from `main` to the Chrome Web Store, what is automated, what is yours, and what to do after
launch.
...
| 3 | Release | **you** confirm; it drives | Rerun with the confirms it printed: tag `v1.5.1`, GitHub Release with the zip, the README's hero as a playable video (`embed-hero-video.sh`), the Homebrew tap, private vulnerability reporting. After this `brew install renchris/tap/natural-tts` works |
